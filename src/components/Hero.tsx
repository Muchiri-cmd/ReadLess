  ...
  return (
    ...
    <div className="max-w-3xl mx-auto text-center">
      ...
      <p className="text-xl text-slate-600 mb-10 leading-relaxed">
        Clear summaries, actionable takeaways, and immediate understanding. Know if a book is worth your time before you commit. And .... 
      ...
      <div className="max-w-2xl mx-auto mb-8">
        <div className="relative">
          ...
          <Link
            to={'/summary/'}
          >
            <button className="absolute right-2 top-1/2 -translate-y-1/2 px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 flex items-center gap-2">
                See Summary
      ...
      <p className="text-sm text-slate-500">Try: "Atomic Habits", "Deep Work", or "Sapiens"</p>
    </div>
  </section>
  )
}
