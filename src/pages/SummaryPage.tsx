  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (err.message?.includes('API key')) {
        ...
        errorMessage += 'Rate limit hit. The free tier has strict limits. Wait 1 minute and try again, or upgrade your API key at https://aistudio.google.com/';
      } else if (err.message?.includes('500') || err.message?.includes('503')) {
        errorMessage += 'Gemini service temporarily unavailable. Please try again in a moment.';
      } else {
